function dydt = PmodelDerivNP(t,y,param)
...
% Local phytoplankton growth rate:
sigma_N = N./(param.H_N + N);
sigma_I = I./(param.H_I + I);
mu = param.gmax*min(sigma_N,sigma_I);
